...
class Game:
    def __init__(self):
        # Player setup        Location of the sprite,        constaints,  speed
        player_sprite = Player((screen_width / 2, screen_height), screen_width, 5)
        self.player = pygame.sprite.GroupSingle(player_sprite)

        # Health and Score setup
        self.lives = 3
        self.lives_surf = pygame.image.load('./games/Space Invaders/graphics/player.png').convert_alpha()
        self.live_x_start_pos = screen_width - (self.lives_surf.get_size()[0] * 2 + 20)
        self.score = 0
        self.level = 0
        self.font = pygame.font.Font('./games/Space Invaders/font/Pixeled.ttf', 20)
        ...
        # Music setup
        music = pygame.mixer.Sound('./games/Space Invaders/audio/music.wav')
        music.set_volume(0.2)
        music.play(loops = -1)
        self.laser_sound = pygame.mixer.Sound('./games/Space Invaders/audio/laser.wav')
        self.laser_sound.set_volume(0.5)
        self.explosion_sound = pygame.mixer.Sound('./games/Space Invaders/audio/explosion.wav')
        ...
        for alien in all_aliens:
            if self.level <= 5:
                if alien.rect.right >= screen_width:
                    self.alien_direction = -1
                    self.alien_move_down(self.level*2)
    ...
    def display_lives(self):
        for life in range(self.lives - 1):
            x = self.live_x_start_pos + (life * (self.lives_surf.get_size()[0] + 10))
    ...
    def display_level(self):
        ...
        level_rect = level_surf.get_rect(center=(screen_width / 2, 20))
...
class CRT:
    def __init__(self):
        self.tv = pygame.image.load('./games/Space Invaders/graphics/tv.png').convert_alpha()
